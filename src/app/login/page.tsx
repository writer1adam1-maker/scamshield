      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card p-6 md:p-8 space-y-5">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-2.5 py-2.5 rounded-lg border border-border text-sm text-text-secondary hover:text-text-primary hover:border-shield/30 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
